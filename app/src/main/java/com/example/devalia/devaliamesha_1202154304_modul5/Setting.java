...
public class Setting extends AppCompatActivity {
    ...
    public String getwarna(int i){ //membuat penkondisian
        if(i==R.color.hijau){
            return "Green";
            //mengembalikan nilai warna hijau
        }else if(i==R.color.biru){
            return "Blue";
            //mengembalikan nilai warna biru
        }else if(i==R.color.merah){
            return "Red";
            //mengembalikan nilai warna merah
        }else if (i==R.color.putih){
            return "White";
            //mengembalikan nilai warna putih
        }else{
            return "Pink";
            //mengembalikan nilai warna pink
    }}
